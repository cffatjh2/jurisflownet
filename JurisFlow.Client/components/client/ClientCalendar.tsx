  ...
  return (
    <div className="p-4 md:p-8 h-full overflow-y-auto">
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        {/* Calendar Grid */}
        <div className="flex-1 min-w-0 bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col overflow-hidden">
        ...
        <div className="w-full xl:w-80 bg-white rounded-xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col">
